...
<html lang="en">
    ...
    ?>
        ...
        <nav class="navigation">
            ...
            <form action="explore.php?curr=<?php echo $us?> &for=<?php echo $us?> &get=search" class="navigation__search-container" method="GET">
        ...
        <footer class="footer" style="z-index:1000;position:fixed; bottom:0; width:100%; left:80px;background-color:#f8f9fa; text-align:center; padding:10px 0;">
